    ...
    <div class="content">
        <div class="page-header">
            <div class="page-title">
                <h4>Menu Cetak Laporan Persediaan</h4>
                    ...
                    <div class="col-lg-3 col-sm-6 col-12">
                        <div class="form-group">
                            ...
                            <div class="input-groupicon">
                                <input type="text" placeholder="DD-MM-YYYY" class="datetimepicker" id="datetimepicker2" name="tglCetakPersed">
                                <div class="addonset">
                                    <img src="<?=base_url('assets/img/icons/calendars.svg')?>" alt="img">
                                </div>
                            </div>
                        </div>
                        <button type="button" class="btn btn-submit me-2" onclick="cetakLapPersediaan()">Unduh</button>
